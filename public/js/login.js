...
document.getElementById("forgotPassword").addEventListener("click", slideDown);
function slideDown() {
  // document.getElementById("paypalLoginForm").style.margin =
  // "-13 0 0 0 !important";
  document.getElementById("paypalLoginForm").classList.add("forgotSlideUp");
  setTimeout(() => {
    document.getElementById("paypalLoginForm").classList.add("forgotSlideDown");
  }, 500);
  document.getElementById("animLoginAndSignup").classList.add("slideDown");
  setTimeout(() => {
    document.getElementById("animLoginAndSignup").style.display = "none";
  }, 2000);
}
